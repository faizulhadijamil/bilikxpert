...
const vBuyMidSep2020SingleAccess = 'e456b524-4689-49eb-808a-08b9a3700aa3'; 
  ...
  class buyMidSep20Promo extends React.Component {
            ...
            <div>   
                <Grid container spacing={24}>
                    <Grid item xs={12}>
                        ...
                        <Typography type="display1" component="h1" color='primary' style={{textAlign:'center', marginTop:0, marginBottom:16}}>
                            M16
                        </Typography>
                    ...
                    <Grid item xs={12} style = {{justifyContent:'center', alignItems:'center'}}>
                        <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                            <img src ={require("../assets/M16promo2.png")} alt="logo" style={{width:300, height:230}} />
                        </div>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={24}>
                    ...
                    <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                      <Button raised color='primary' key={'allAccessKlcc'} classes={{raisedPrimary:classes.buttonLarge, disabled:classes.buttonDisabled}} onClick={()=>this.props.actions.viewVendItem(vBuyMidSep2020AllAccess)}>All Access</Button>
                    </div>
                    <Typography type="subheading" component="h1" color="primary" style={{textAlign:'center', marginTop:0, marginBottom:0}}>
                  ...
                  {false && <Grid item xs={12} sm={12} lg={12}>
                    <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                      <Button raised color='primary' key={'singleAccessTTDI'} classes={{raisedPrimary:classes.buttonLarge, disabled:classes.buttonDisabled}} onClick={()=>this.props.actions.viewVendItem(vBuyMidSep2020SingleAccess)}>Single Access</Button>
                    </div>
                    <Typography type="subheading" component="h1" color="primary" style={{textAlign:'center', marginTop:0, marginBottom:0}}>
                      {`single Access to TTDI`}
                    </Typography>
                  </Grid>}
  ...
  buyMidSep20Promo.propTypes = {
    classes: PropTypes.object.isRequired,
  };

  const buyMidSep20PromoStyled = withStyles(styles)(buyMidSep20Promo);
  ...
  export default connect(makeMapStateToProps, mapDispatchToProps)(buyMidSep20PromoStyled)
