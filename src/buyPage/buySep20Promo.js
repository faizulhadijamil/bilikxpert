...
const vBuySep2020AllAccess = 'e4c23eae-4a4d-9191-f92f-98afe0e3dd08'; // need to change
// const vBuySep2020AllAccess = '83d318ff-64ab-3cc8-9ba4-98f740bc48f2'; // need to change
// 8aea002d-7eaa-1a6b-362d-933243a75823

  class buySep20Promo extends React.Component {
        ...
        <div className={classes.container}>
            ...
            <div>   
                <Grid container spacing={24}>
                    ...
                    <Grid item xs={12} style = {{justifyContent:'center', alignItems:'center'}}>
                        <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                            <img src ={require("../assets/uno.png")} alt="logo" style={{width:300, height:230}} />
                        </div>
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={24}>
                    ...
                    <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                      <Button raised color='primary' key={'allAccessKlcc'} classes={{raisedPrimary:classes.buttonLarge, disabled:classes.buttonDisabled}} onClick={()=>this.props.actions.viewVendItem(vBuySep2020AllAccess)}>All Access</Button>
                    </div>
                    <Typography type="subheading" component="h1" color="primary" style={{textAlign:'center', marginTop:0, marginBottom:0}}>
                      {`4-Month Membership Access to KLCC & TTDI`}
                    </Typography>
                  </Grid>
  ...
  buySep20Promo.propTypes = {
    classes: PropTypes.object.isRequired,
  };

  const buySep20PromoStyled = withStyles(styles)(buySep20Promo);
  ...
  export default connect(makeMapStateToProps, mapDispatchToProps)(buySep20PromoStyled)
