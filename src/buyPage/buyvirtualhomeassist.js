  ...
  import {withStyles, CircularProgress, Dialog, Button, Typography, 
    Grid, TextField, FormGroup, FormControlLabel, Checkbox, Avatar
...
var ismobile = window.innerWidth<=550?true:false;
  ...
  class buyvirtualhomeassist extends React.Component {
  ...
  buyvirtualhomeassist.propTypes = {
    classes: PropTypes.object.isRequired,
  };

  const buyvirtualhomeassistStyled = withStyles(styles)(buyvirtualhomeassist);
  ...
  export default connect(makeMapStateToProps, mapDispatchToProps)(buyvirtualhomeassistStyled)
