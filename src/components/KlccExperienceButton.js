...
const styles = theme => ({
    ...
    buttonText:{
        letterSpacing:1, fontSize:ismobile?'13px':'1.4rem', color:'#fff', textAlign:'center'
    },
    buttonTextBig:{
        letterSpacing:1, fontSize: ismobile? '1rem':'2rem', color:'#000', textAlign:'center'
    },
    bigbutton:{
        paddingLeft: 25,
        paddingRight: 25,
...
class KlccExperienceButton extends React.Component {
  ...
  KlccExperienceButton.propTypes = {
    classes: PropTypes.object.isRequired,
};

const KlccExperienceButtonStyled = withStyles(styles)(KlccExperienceButton);
...
export default connect(mapStateToProps, mapDispatchToProps)(KlccExperienceButtonStyled)